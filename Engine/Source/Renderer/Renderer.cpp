...
void Renderer::Init(GLFWwindow* window)
{
    ...
    ShaderManager::Add(Shader("Geometry_Skeletal", ENGINE_PATH("Shaders\\geometry.glsl"), { "SKELETAL" }));

    ShaderManager::Add(Shader("PointShadow", ENGINE_PATH("Shaders\\pointShadow.glsl")));
    ShaderManager::Add(Shader("PointShadow_Skeletal", ENGINE_PATH("Shaders\\pointShadow.glsl"), { "SKELETAL" }));
    ShaderManager::Add(Shader("DirectionalShadow", ENGINE_PATH("Shaders\\directionalShadow.glsl")));
    ShaderManager::Add(Shader("DirectionalShadow_Skeletal", ENGINE_PATH("Shaders\\directionalShadow.glsl"), { "SKELETAL" }));

    ShaderManager::Add(Shader("PBR", ENGINE_PATH("Shaders\\pbr.glsl")));
    ShaderManager::Add(Shader("PBR_Skeletal", ENGINE_PATH("Shaders\\pbr.glsl"), { "SKELETAL" }));

    ShaderManager::Add(Shader("EntityBuffer", ENGINE_PATH("Shaders\\entityBuffer.glsl")));
    ShaderManager::Add(Shader("EntityBuffer_Skeletal", ENGINE_PATH("Shaders\\entityBuffer.glsl"), { "SKELETAL" }));
    ShaderManager::Add(Shader("Mask", ENGINE_PATH("Shaders\\mask.glsl")));
    ShaderManager::Add(Shader("Mask_Skeletal", ENGINE_PATH("Shaders\\mask.glsl"), { "SKELETAL" }));
