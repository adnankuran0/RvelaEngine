...
ImGuiLayer_old::~ImGuiLayer_old()
{
}

void ImGuiLayer_old::OnAttach()
{
    IMGUI_CHECKVERSION();
    ImGui::CreateContext();
...
void ImGuiLayer_old::DrawCreateProjectPopup(Engine* engine)
{
...
void ImGuiLayer_old::DrawSceneHierarchyPanel(entt::registry& registry, entt::entity& selectedEntity)
{
...
void ImGuiLayer_old::DrawInspectorPanel(entt::registry& registry, entt::entity& selectedEntity)
{
